...
* `SessionEventSimpleConsumers`기본 시간 초과: 180초(Timeout.TIMEOUT\_180\_SECONDS)
* `AssistantContentSimpleConsumers`기본 시간 초과: 60초(Timeout.TIMEOUT\_60\_SECONDS)
...
* **스레드 이름 지정**: "qwen\_code\_cli-pool-{번호}"
* **데몬 스레드**: 거짓

...
- _이는 지역적으로 파괴적입니다._ `npm uninstall @qwen-code/qwen-code && npm uninstall -g @qwen-code/qwen-code && npm cache clean --force &&  npm install @qwen-code/qwen-code@<version>`
...
- 파일 이동:
  - 패키지/코어/src/\*_/_.ts -> 컴파일 -> 패키지/코어/dist/
  - 패키지/cli/src/\*_/_.ts -> 컴파일 -> 패키지/cli/dist/

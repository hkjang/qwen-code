...
| `/remember`      | 지속적인 메모리 저장                   | `/remember Prefer terse responses`            |
...
| 명령                   | 설명                       |
| ---------------------- | -------------------------- |
| `/btw <your question>` | 간단한 부가 질문 하기      |
...
| ACP(에이전트 프로토콜) | stream_messages 비동기 생성기를 반환합니다.      |
...
```markdown
---
description: 선택 description (displayed in /help)
---
...
| 필드          | 필수의    | 설명                          | 예                               |
| ------------- | --------- | ----------------------------- | -------------------------------- |
| `description` | 선택 과목 | 명령 설명(/help에 표시됨)     | `description: 코드 분석 도구`    |
